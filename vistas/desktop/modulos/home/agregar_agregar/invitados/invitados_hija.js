$(document).ready(function () {
  ...
  $("#btn_agregar_invitado_hija").click(function () {
    agregarInvitado_act_hija();
  });
//    cargar_invitados();
  triggersInvitado_act_hija();
});
function agregarInvitado_act_hija() {
  ...
  html += '</select>   ' +
          ...
          '<div class="col-sm-1 ">' +
          '<button type="button"  class="btn btn_eliminar_reg_invitado_act_hija btn-primary  btn-md"><i class="fa fa-minus"></i></button> ' +
          '</div>' +
          '</div>';
  aux++;

  $('#div_agregar_invitados_hija').append(html);
  triggersInvitado_act_hija();
...
function triggersInvitado_act_hija() {
  $('.btn_eliminar_reg_invitado_act_hija').on('click', function () {
    eliminarCampoRegistroInvitado_act_hija($(this).parent().parent());
  });

}
function del_invitado(obj) {
  eliminarCampoRegistroInvitado_act_hija($(obj).parent().parent());
}


function eliminarCampoRegistroInvitado_act_hija(div) {
...
function cargar_invitados_act_hija() {
